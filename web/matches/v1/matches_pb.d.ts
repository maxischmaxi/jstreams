...
import type { RegionalRoutingValues } from "../../account/v1/account_pb.js";
...
export declare class MatchInfo extends Message<MatchInfo> {
  ...
  /**
   * @generated from field: int64 gameCreation = 2;
   */
  gameCreation: bigint;
  ...
  /**
   * @generated from field: int64 gameEndTimestamp = 4;
   */
  gameEndTimestamp: bigint;

  /**
   * @generated from field: int64 gameId = 5;
   */
  gameId: bigint;
  ...
  /**
   * @generated from field: int64 gameStartTimestamp = 8;
   */
...
export declare class Team extends Message<Team> {
  ...
  /**
   * @generated from field: matches.Objectives objectives = 2;
   */
...
/**
 * @generated from message matches.Objectives
 */
export declare class Objectives extends Message<Objectives> {
  /**
  ...
  constructor(data?: PartialMessage<Objectives>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "matches.Objectives";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Objectives;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Objectives;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Objectives;

  static equals(a: Objectives | PlainMessage<Objectives> | undefined, b: Objectives | PlainMessage<Objectives> | undefined): boolean;
}
...
export declare class MatchParticipant extends Message<MatchParticipant> {
  ...
  /**
   * @generated from field: map<string, int32> missions = 59;
   */
  ...
  /**
   * @generated from field: matches.Perks perks = 70;
   */
  perks?: Perks;
...
/**
 * @generated from message matches.Perks
 */
export declare class Perks extends Message<Perks> {
  /**
  ...
  /**
   * @generated from field: repeated matches.StylePerks styles = 2;
   */
  styles: StylePerks[];

  constructor(data?: PartialMessage<Perks>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "matches.Perks";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Perks;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Perks;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Perks;

  static equals(a: Perks | PlainMessage<Perks> | undefined, b: Perks | PlainMessage<Perks> | undefined): boolean;
}
