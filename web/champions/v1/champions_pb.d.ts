...
export declare class ChampionStats extends Message<ChampionStats> {
  ...
  /**
   * @generated from field: float mpperlevel = 4;
   */
  mpperlevel: number;
  ...
  /**
   * @generated from field: float armorperlevel = 7;
   */
  ...
  /**
   * @generated from field: float spellblockperlevel = 9;
   */
  ...
  /**
   * @generated from field: float hpregen = 11;
   */
  hpregen: number;

  /**
   * @generated from field: float hpregenperlevel = 12;
   */
  hpregenperlevel: number;

  /**
   * @generated from field: float mpregen = 13;
   */
  mpregen: number;

  /**
   * @generated from field: float mpregenperlevel = 14;
   */
  ...
  /**
   * @generated from field: float critperlevel = 16;
   */
  critperlevel: number;
  ...
  /**
   * @generated from field: float attackdamageperlevel = 18;
   */
  attackdamageperlevel: number;

  /**
   * @generated from field: float attackspeed = 19;
   */
  attackspeed: number;

  /**
   * @generated from field: float attackspeedperlevel = 20;
   */
