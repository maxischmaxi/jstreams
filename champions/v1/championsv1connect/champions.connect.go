...
const (
	...
	// ChampionsServiceGetChampByChampIdProcedure is the fully-qualified name of the ChampionsService's
	// GetChampByChampId RPC.
	ChampionsServiceGetChampByChampIdProcedure = "/champions.ChampionsService/GetChampByChampId"
)
...
var (
	...
	championsServiceGetChampByChampIdMethodDescriptor = championsServiceServiceDescriptor.Methods().ByName("GetChampByChampId")
)
...
type ChampionsServiceClient interface {
	...
	GetChampByChampId(context.Context, *connect.Request[v1.GetChampByChampIdRequest]) (*connect.Response[v1.GetChampByChampIdResponse], error)
}
...
func NewChampionsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ChampionsServiceClient {
	...
	return &championsServiceClient{
		...
		getChampByChampId: connect.NewClient[v1.GetChampByChampIdRequest, v1.GetChampByChampIdResponse](
			httpClient,
			baseURL+ChampionsServiceGetChampByChampIdProcedure,
			connect.WithSchema(championsServiceGetChampByChampIdMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type championsServiceClient struct {
	...
	getChampByChampId *connect.Client[v1.GetChampByChampIdRequest, v1.GetChampByChampIdResponse]
}
...
// GetChampByChampId calls champions.ChampionsService.GetChampByChampId.
func (c *championsServiceClient) GetChampByChampId(ctx context.Context, req *connect.Request[v1.GetChampByChampIdRequest]) (*connect.Response[v1.GetChampByChampIdResponse], error) {
	return c.getChampByChampId.CallUnary(ctx, req)
}
...
func NewChampionsServiceHandler(svc ChampionsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	championsServiceGetChampByChampIdHandler := connect.NewUnaryHandler(
		ChampionsServiceGetChampByChampIdProcedure,
		svc.GetChampByChampId,
		connect.WithSchema(championsServiceGetChampByChampIdMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	return "/champions.ChampionsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case ChampionsServiceGetChampByChampIdProcedure:
			championsServiceGetChampByChampIdHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedChampionsServiceHandler) GetChampByChampId(context.Context, *connect.Request[v1.GetChampByChampIdRequest]) (*connect.Response[v1.GetChampByChampIdResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("champions.ChampionsService.GetChampByChampId is not implemented"))
}
